...
// Assuming you have a function to escape data (replace with your actual function)
function your_escape_function($value) {
    // Implement your escaping logic here
    // Example: return mysqli_real_escape_string($your_database_connection, $value);
    return $value; // For demonstration purposes, just returning the value without escaping
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["file"])) {
    ...
    if (in_array(strtolower($file_extension), $allowed_extensions)) {
        ...
        foreach ($sheet->getRowIterator() as $row) {
            ...
            // Note: Replace the above example query with the actual query you use to insert data into your database.
        }
