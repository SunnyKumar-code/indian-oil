...
$vendor_code = isset($_GET['vendor_code']) ? $_GET['vendor_code'] : '';
...
<body>
    ...
    <div class="content-container">
        ...
        <?php if ($row) : ?>
            <form method="POST" action="update_apprentice.php">
                ...
                <div>
                    ...
                    <input type="text" id="Discipline" name="Discipline" value="<?php echo $row['Discipline']; ?>">
                </div>
                <div>
                    <label for="Enrollment_ID">Enrollment_ID:</label>
                    <input type="text" id="Enrollment_ID" name="Enrollment_ID" value="<?php echo $row['Enrollment_ID']; ?>">
                </div>
                <div>
                ...
                <div>
                    <label for="State_Office">State Office:</label>
                    <input type="text" id="State_Office" name="State_Office" value="<?php echo $row['State_Office']; ?>">
                </div>
                <div>
                ...
                <div>
                    <label for="cl_balance">Cl Leave:</label>
                    <input type="text" id="cl_balance" name="cl_balance" value="<?php echo $row['cl_balance']; ?>">
                </div>

                <div>
                    <label for="gl_balance">Gl Leave:</label>
                    <input type="text" id="gl_balance" name="gl_balance" value="<?php echo $row['gl_balance']; ?>">
                </div>
                <div>
                ...
                <div>
                    ...
                    <span id="showPassword" style="position: absolute; top: 1330px; right: 25px; cursor: pointer;">👁️</span>
                </div>
                <div>
