...
<body>
    <nav>
        <a href="admin.php?username=<?php echo $_SESSION['username']; ?>"><i class="fas fa-home"></i></a>
            ...
            if ($searchType == "vendor" && isset($srchrow['vendor_code'])) {
                echo "<table class='search-results'>
                    ...
                    <tr>
                        ...
                        <td><a href='appedit.php?vendor_code=" . $srchrow['vendor_code'] . "' class='edit-button'>Edit</a></td>
                    </tr>
                </table>";
                ...
                // Debugging: Print the value of $srchrow when employee is clicked
                echo "Clicked Employee ID: " . $srchrow['employeeid'];
            } else {
